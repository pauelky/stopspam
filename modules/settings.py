...
Антифлуд в личке:
/flood on - включить автомьют за флуд во всех личных чатах
/flood off - выключить автомьют за флуд
/flood status - показать статус

Правило: больше 5 сообщений за 10 секунд. Мьюты за день: 3, 5, 10 минут. Сброс раз в сутки.
"""
